...
function CouchBand() {
  return (
    <section className="kbc-couch-band">
      <svg className="kbc-couch-bg" viewBox="0 0 1400 600" preserveAspectRatio="xMidYMid slice" aria-hidden="true">
        <defs>
        ...
        <rect x="0" y="460" width="1400" height="140" fill="#1a2a18" opacity="0.35"/>
      </svg>
      <div className="kbc-couch-overlay" aria-hidden="true"></div>
      <div className="kbc-couch-content">
        <div className="kbc-eyebrow kbc-eyebrow-on-dark">A Quiet Promise</div>
        <p className="kbc-pullquote">
