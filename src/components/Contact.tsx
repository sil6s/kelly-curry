...
export default function Contact() {
  ...
  return (
    <section className={styles['kbc-contact-v2-section']} id="contact">
      <div className={styles['kbc-contact-v2-inner']}>
        <div className={styles['kbc-contact-v2-header']}>
          <SectionEyebrow>Get in Touch</SectionEyebrow>
          <h2 className={styles['kbc-h2']}>
            Reach out for a brief, <em>free</em> consultation.
          </h2>
          <p className={styles['kbc-body']}>
            You do not need to have everything figured out. Share a little about
            what you are looking for, and Kelly will follow up to discuss fit,
            availability, and next steps.
          </p>
        </div>

        {submitted ? (
          <div className={styles['kbc-contact-v2-card']}>
            <div className={styles['kbc-contact-v2-success']}>
              <div className={styles['kbc-eyebrow']}>Thank You</div>
              <h3 className={styles['kbc-step-heading']}>
                Your message is on its way.
              </h3>
              <p className={styles['kbc-body']}>
                Kelly will follow up about availability, fit, and next steps.
                As a solo provider, she will respond as soon as she is
                able — typically within two business days.
              </p>
            </div>
          </div>
        ) : (
          <div className={styles['kbc-contact-v2-card']}>
            ...
            <form className={styles['kbc-contact-form']} onSubmit={handleSubmit}>
              {step === 1 && (
                <>
                  <h3 className={styles['kbc-step-heading']}>Basic Information</h3>
