  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 32 32" aria-hidden="true">
        ...
        <path
          d="M11 10 C11 10, 11 19, 16 22 C21 19, 21 10, 21 10"
          fill="none"
          stroke="#005587"
          strokeWidth="2"
          strokeLinecap="round"
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 32 32" aria-hidden="true">
        ...
        />
        <path
          d="M12 12 V10 C12 8, 20 8, 20 10 V12"
          fill="none"
          stroke="#0066CC"
          strokeWidth="2"
          strokeLinecap="round"
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 32 32" aria-hidden="true">
        ...
        <path
          d="M16 7 L19 13 L26 14 L21 19 L22.5 26 L16 23 L9.5 26 L11 19 L6 14 L13 13 Z"
          fill="none"
          stroke="#2D7D46"
          strokeWidth="1.8"
          strokeLinejoin="round"
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 32 32" aria-hidden="true">
        ...
        <path
          d="M16 8 C16 8, 10 11, 10 16 C10 21, 16 24, 16 24 C16 24, 22 21, 22 16 C22 11, 16 8, 16 8 Z"
          fill="none"
          stroke="#00539B"
          strokeWidth="2"
        />
        <path
          d="M13 16 L15.5 18.5 L20 13.5"
          stroke="#00539B"
          strokeWidth="2"
          strokeLinecap="round"
          strokeLinejoin="round"
...
const PAYMENT_METHODS = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 32 32" aria-hidden="true">
        <path
          d="M16 4 L28 10 L28 18 C28 23, 22 27, 16 29 C10 27, 4 23, 4 18 L4 10 Z"
          fill="none"
          stroke="currentColor"
          strokeWidth="2"
          strokeLinejoin="round"
      ...
      <div className={styles['kbc-fees-grid']}>
        {FEES.map((f) => (
          <div key={f.label} className={styles['kbc-fee-block']}>
            ...
            {'payOnly' in f && f.payOnly ? (
              <div className={styles['kbc-service-pay-label']}>{f.payOnly}</div>
            ) : null}
            ...
            <div className={styles['kbc-insurance-cards-row']}>
              {INSURANCE.map((ins) => (
                <div key={ins.name} className={styles['kbc-insurance-card']}>
                  <div className={styles['kbc-insurance-card-icon']}>
                    {ins.icon}
                  </div>
                  <span className={styles['kbc-insurance-card-name']}>
                    {ins.name}
                  </span>
                </div>
              ))}
            ...
            <div className={styles['kbc-payment-cards-row']}>
              {PAYMENT_METHODS.map((method) => (
                <div key={method.name} className={styles['kbc-payment-card']}>
                  <div className={styles['kbc-payment-card-icon']}>
                    {method.icon}
                  </div>
                  <span className={styles['kbc-payment-card-name']}>
                    {method.name}
                  </span>
                </div>
              ))}
